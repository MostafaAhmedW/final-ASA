      ...
      <SectionWrapper>
        <section dir="rtl" className="py-20 bg-gray-100">
          <div className="container md:px-10 mx-auto text-center text-white">
            <h2 className="text-center text-3xl  font-bold text-[#318160] mb-10">
              التعليم هو أساس التنمية
            </h2>

            <p className="text-gray-600 font-light leading-relaxed md:text-lg mb-6 p-4 md:p-5">
              تؤمن مبادرة حياة كريمة بأن الاستثمار في التعليم هو الطريق الحقيقي
              لبناء الإنسان، وتسعى إلى تطوير المنظومة التعليمية داخل القرى
              الأكثر احتياجًا، بما يضمن تكافؤ الفرص وصناعة مستقبل أفضل للأجيال
              القادمة.
            </p>
