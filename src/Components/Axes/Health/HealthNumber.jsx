...
export default function HealthNumber() {
          ...
          <div className="relative bg-center bg-cover bg-[url('/Images/layout.webp')]">
            ...
            <div className="relative z-10">
              ...
              <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-10 p-6 text-center">
                <div className="p-6 rounded-2xl shadow-lg text-white">
                  <div className="flex justify-center items-center mb-2">
                    ...
                    <h3 className="text-2xl font-bold">
                      {inView && <CountUp end={1500000} duration={3} />}+
                    </h3>
                  </div>
                  <p className="leading-relaxed text-center text-lg font-light">
                    مستفيد من الخدمات الصحية
                  </p>
                </div>

                <div className="p-6 rounded-2xl shadow-lg text-white">
                  <div className="flex justify-center items-center mb-2">
                    <RiHospitalLine className="text-2xl ml-2 text-[#6fc5a3d8]" />
                    <h3 className="text-2xl font-bold">
                      {inView && (
                ...
                <div className="p-6 rounded-2xl shadow-lg text-white">
                  <div className="flex justify-center items-center mb-2">
                    <PiAmbulance className="text-2xl ml-2 text-[#6fc5a3d8]" />
                    <h3 className="text-2xl font-bold">
                      {inView && (
                        <CountUp end={5500} duration={3} separator="," />
                      )}
                      +
                    </h3>
                  </div>
