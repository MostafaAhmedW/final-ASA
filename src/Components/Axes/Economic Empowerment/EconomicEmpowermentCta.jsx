...
export default function EconomicEmpowermentCta() {
  return (
    <>
      <SectionWrapper>
        <section dir="rtl" className="py-20 bg-gray-100 ">
          <div className="container md:px-10 mx-auto text-center text-white">
            <h2 className="text-center text-3xl text-[#318160] font-bold mb-10">
              التمكين الاقتصادي طريق التنمية
            </h2>

            <p className="text-gray-600 font-light leading-relaxed md:text-lg mb-6 p-4 md:p-5">
              تؤمن مبادرة حياة كريمة بأن دعم الأنشطة الاقتصادية وتوفير فرص العمل
              هو الأساس لبناء حياة كريمة للمواطنين داخل القرى الأكثر احتياجًا،
              بما يضمن تحسين الدخل والرفاهية وصناعة مستقبل مستدام للأجيال
              القادمة.
            </p>
